...
public class DBHelper extends SQLiteOpenHelper implements DbTableNames {
    ...
    protected static final String CREATE_STOREFURNISH_TABLE = "create table " + TABLE_STORESFURNITURES + " (_id nvarchar2 not null primary key, storeId nvarchar2 REFERENCES " + TABLE_STORES + " (_id), furnitureId nvarchar2 REFERENCES " + TABLE_FURNITURES + " (_id));";
